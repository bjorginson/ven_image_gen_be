...
def main():
    ...
    with torch.inference_mode():
        ...
        loraloader_18 = loraloader.load_lora(
            lora_name="Perfect Eyes XL/PerfectEyesXL-mid_118427-vid_128461.safetensors",
            strength_model=1,
            strength_clip=1,
        ...
        user_prompt = open(prompt_file_path, "r").read()
        ...
        for q in range(1):
            ...
            ultimatesdupscale_13 = ultimatesdupscale.upscale(
                upscale_by=2,
                seed=random.randint(1, 2**64),
                steps=4,
                cfg=8,
                ...
                negative=get_value_at_index(cliptextencode_7, 0),
                vae=get_value_at_index(checkpointloadersimple_4, 2),
                upscale_model=get_value_at_index(upscalemodelloader_15, 0),
            )

            file_name_prefix_path = "./file_name.txt"
            prefix = open(file_name_prefix_path, "r").read()

            saveimage_9 = saveimage.save_images(
                filename_prefix=prefix,
                images=get_value_at_index(ultimatesdupscale_13, 0)
            )
